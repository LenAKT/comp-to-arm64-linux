          ...
          if (it != delimiterMap.end())
          {
            ...
            switch (del)
            {
                ...
                case Delimiter::BraceClose:{
                    ...
                    {
                        int a;
                        nFunction->fContainer.insert(nFunction->fContainer.end(), preTokens.begin() + track, preTokens.begin()+i);
                        preTokens.erase(preTokens.begin()+track2, preTokens.begin()+i+1);
                        i = i - (i+1-track2);
                    }
